...
Follow these steps to run both the backend and frontend on your local machine:
...
2. Install dependencies:
   ...
   npm install
   ```
3. Create a `.env` file in the `backend/` folder and add your API keys (see example below):
   ```env
   PORT=5000
...
From the root `mind` directory, you can install all dependencies and run both servers at once:
